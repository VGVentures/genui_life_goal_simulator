...
Future<void> main() async {
  await SentryFlutter.init(
    (options) {
      options.dsn = 'https://75a71ac4db863a4e5fb99a10ca1d9343@o4510874275872768.ingest.us.sentry.io/4510874315390976'; // ← Pega tu DSN de Sentry aquí
    ...
    appRunner: () => bootstrap(
      ...
      errorReportingRepository: ProdErrorReportingRepository(
        HubAdapter(), // ← Esto conecta con Sentry
      ),
    ),
  );
}
